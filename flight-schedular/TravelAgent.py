...
class TravelAgent:
    ...
    """
        ...
        start-date:when you want to start the trip
    ...
    def set_trip_multi_city_one_way_fixed_route(self,trip_info,start_date):
        ...
        for i in range(0,len(trip_info)-1):
            ...
            trips.append(trip)
        return trips                                                         
    def set_trip_multi_city_flexible_route(self,trip_info,start_date):
        start_city=trip_info[0]
        flexible_cities=trip_info[1:]
        min_price=float('inf')
        selected_trips=None
